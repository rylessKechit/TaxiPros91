...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Taxi Massy, Orly, Saclay 24h/24 | TAXI Pro 91',
    template: '%s | TAXI Pro 91',
  },
  description: 'Taxi en Essonne (91) disponible 24h/24. Massy, Palaiseau, Antony, Saclay, Les Ulis. Transferts Orly & CDG, gare Massy TGV, transport médical CPAM. Note 4.9/5 ★',
