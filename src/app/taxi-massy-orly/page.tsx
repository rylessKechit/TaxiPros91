...
const ROUTE = popularRoutes.find(r => r.slug === 'taxi-massy-orly')!
...
const faqs = [
  {
    ...
    a: `Le prix d'un taxi de ${FROM} vers l'aéroport d'Orly est compris entre ${PRICE_MIN}€ et ${PRICE_MAX}€ selon l'heure (tarif jour ou tarif nuit/dimanche/jours fériés) et les conditions de circulation. Ce tarif est fixe, communiqué à la réservation et inclut la prise en charge, l'attente au terminal et l'aide aux bagages. Aucune mauvaise surprise à l'arrivée.`,
  },
  {
    q: `Combien de temps dure le trajet ${FROM} Orly en taxi ?`,
    a: `Le trajet ${FROM} → Aéroport d'Orly dure en moyenne ${DURATION} minutes en taxi via l'autoroute A10 puis l'A106. Aux heures de pointe (7h-9h et 17h-20h), comptez 20 à 25 minutes. En heures creuses ou la nuit, le trajet peut se faire en 12 minutes seulement.`,
  },
  {
    q: 'Comment réserver un taxi de Massy vers Orly ?',
    a: `Trois options : appelez le ${SITE.phone.display} disponible 24h/24, utilisez le formulaire de réservation en ligne (confirmation immédiate par email et SMS), ou réservez à l'avance pour un trajet matinal. Pour un vol tôt le matin, nous recommandons de réserver au moins la veille (J-1).`,
  },
  {
    q: 'Quels moyens de paiement acceptez-vous ?',
    a: `Tous nos taxis acceptent la carte bancaire (Visa, Mastercard, American Express), les espèces et les bons de transport CPAM. La facturation entreprise est disponible sur demande pour vos déplacements professionnels vers Orly.`,
  },
  {
    q: 'Proposez-vous l\'aller-retour Massy ↔ Orly ?',
    a: `Oui, nous proposons un forfait aller-retour Massy ↔ Orly à tarif préférentiel. Idéal pour un voyage court ou un déplacement professionnel. Indiquez les horaires aller et retour à la réservation ; le chauffeur vous attend à votre vol retour avec suivi en temps réel.`,
  },
  {
...
const usp = [
  { icon: Clock, title: 'Disponible 24h/24', desc: 'Vols tôt le matin, vols de nuit, week-ends : nous sommes là à toute heure pour votre trajet Massy Orly.' },
  ...
  { icon: Shield, title: 'Chauffeurs professionnels', desc: 'Conducteurs expérimentés, véhicules récents et entretenus, aide aux bagages systématique.' },
]

const avis = [
  { nom: 'Marie L. (Massy)', note: 5, texte: `Réservé la veille pour un vol à 7h depuis Orly 4. Le chauffeur était devant chez moi à 5h30 pétantes, trajet en 15 minutes par l'A10, tarif annoncé respecté. Service au top, je recommande pour Orly.`, date: 'Mars 2025' },
  { nom: 'Pierre D. (Massy-Verrières)', note: 5, texte: `J'utilise TAXI Pro 91 chaque mois pour mes déplacements pros Massy → Orly 2. Toujours ponctuel, voiture propre, facturation entreprise simple. Bien meilleur qu'un VTC à prix variable.`, date: 'Février 2025' },
  { nom: 'Sophie M. (Atlantis)', note: 5, texte: `Vol retour retardé de 2h, le chauffeur a attendu sans supplément. Suivi de vol vraiment fonctionnel. Merci !`, date: 'Janvier 2025' },
  { nom: 'Jean B. (Massy-Opéra)', note: 5, texte: `Aller-retour Massy-Orly pour un week-end à Marrakech. Prix imbattable comparé aux applications VTC qui surchargent aux heures de pointe. Parfait.`, date: 'Avril 2025' },
]

const autresTrajets = popularRoutes.filter(r => r.fromSlug === 'massy' && r.slug !== 'taxi-massy-orly')

export default function TaxiMassyOrly() {
  return (
    <>
      <Header />
      ...
      <ServiceSchema
        name={`Taxi ${FROM} ${TO}`}
        description={`Service de taxi entre ${FROM} (91300) et l'aéroport d'Orly. Tarif fixe dès ${PRICE_MIN}€, trajet en ${DURATION} minutes, disponible 24h/24 avec suivi de vol inclus.`}
        url={URL}
      ...
      <main>
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-start">
              <div>
                <div className="flex items-center gap-2 text-yellow-600 mb-3">
                  ...
                  <span className="font-medium">{FROM} (91300) → Aéroport Orly</span>
                </div>
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  ...
                  Trajet rapide en <strong>{DURATION} minutes</strong> via l'A10, prise en charge à votre adresse à {FROM}
                  et dépose directe à votre terminal (Orly 1, 2, 3 ou 4). Service disponible 24h/24 et 7j/7.
                </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-600 mb-8">
                ...
                aucun compteur qui s'emballe dans les bouchons. Voici notre grille indicative pour le trajet {FROM} Orly.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    L'itinéraire le plus direct emprunte la <strong>D188</strong> au départ de {FROM},
                    puis rejoint l'<strong>autoroute A10</strong> en direction de Paris, avant de bifurquer
                    sur l'<strong>A106</strong> qui dessert directement les terminaux d'Orly. Aucun péage sur ce parcours.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-xl p-6 border border-gray-200">
                  ...
                  <ul className="text-gray-600 text-sm space-y-2">
                    ...
                    <li><strong>Heures de pointe (7h-9h / 17h-20h) :</strong> 20-25 minutes</li>
              ...
              <p className="text-gray-600">
                ...
                connaissent les itinéraires alternatifs (par la D118 ou la N20) en cas d'incident sur l'A10.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
              Plus de 10 ans d'expérience sur l'axe Massy-Orly, des centaines de transferts aéroport chaque mois.
            </p>
